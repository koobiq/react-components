...
For new code prefer [DropdownMenu](?path=/docs/components-dropdownmenu--docs):
it is built on React Aria Components and supports submenus and search.
...
- `Menu.ItemAddon` — a component to show addon in a menu item.
