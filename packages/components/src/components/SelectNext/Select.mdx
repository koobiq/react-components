...
Overflowing text and truncated captions inside `Select.ItemText` show their full
content on hover. Use `hideTooltip` to disable this behavior for both lines.

<Story of={Stories.OverflowTooltips} />
