...
Use `messages` to change standard text. Use `slotProps` for the list, compact
empty state, add-more area, and drop overlay. Use `renderEmptyState` to replace
the large empty state.
