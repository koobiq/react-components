...
/**
 * @deprecated
 * This icon has been deprecated, please use IconCircleXmarkS24 instead.
 */
export const IconXmarkCircleS24 = forwardRef(
...
IconXmarkCircleS24.displayName = 'IconXmarkCircleS24';
