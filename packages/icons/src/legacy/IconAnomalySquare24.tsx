...
/**
 * @deprecated
 * This icon has been deprecated, please use IconSquareA24 instead.
 */
export const IconAnomalySquare24 = forwardRef(
...
IconAnomalySquare24.displayName = 'IconAnomalySquare24';
