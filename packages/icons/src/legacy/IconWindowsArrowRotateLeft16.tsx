...
/**
 * @deprecated
 * This icon has been deprecated, please use IconArrowRotateLeftBadgeWindows16 instead.
 */
export const IconWindowsArrowRotateLeft16 = forwardRef(
