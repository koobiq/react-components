...
/**
 * @deprecated
 * This icon has been deprecated, please use IconRectangleIp416 instead.
 */
export const IconIp4Rectangle16 = forwardRef(
  (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    ...
    >
      <g>
        <path d="M11.935 6.243v2.623h-1.676v-.048l1.627-2.575zM5.557 7.948V5.887h.881c.755 0 1.12.41 1.12 1.026 0 .613-.365 1.035-1.114 1.035z" />
...
IconIp4Rectangle16.displayName = 'IconIp4Rectangle16';
