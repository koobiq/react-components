...
/**
 * @deprecated
 * This icon has been deprecated, please use IconCircleArrowRightDotO24 instead.
 */
export const IconArrowRightCircleDotO24 = forwardRef(
