...
/**
 * @deprecated
 * This icon has been deprecated, please use IconCirclePause16 instead.
 */
export const IconPauseCircle16 = forwardRef(
...
IconPauseCircle16.displayName = 'IconPauseCircle16';
