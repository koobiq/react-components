...
export const IconBsd24 = forwardRef(
  (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    ...
    >
      <g>
        <path d="M14.89 5.081s6.252-4.544 7.422-3.395c1.17 1.147-3.49 7.448-3.49 7.448-3.561-1.207-3.932-4.053-3.932-4.053M3.27 1.612c-.94.626.21 3.667.21 3.667S4.492 3.072 6.775 3.2c0 0-2.564-2.214-3.505-1.587" />
...
IconBsd24.displayName = 'IconBsd24';
