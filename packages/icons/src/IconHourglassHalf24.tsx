...
export const IconHourglassHalf24 = forwardRef(
  (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    ...
    >
      <g>
        <path d="M7.5 4.8a.3.3 0 0 1 .3-.3h8.407a.3.3 0 0 1 .3.3v1.853a.3.3 0 0 1-.088.213l-4.215 4.174a.3.3 0 0 1-.422 0L7.588 6.865a.3.3 0 0 1-.088-.213zM11.328 13.05a.3.3 0 0 1 .3-.3h.736a.3.3 0 0 1 .3.3v.736a.3.3 0 0 1-.3.3h-.736a.3.3 0 0 1-.3-.3zM12.664 15.745a.3.3 0 0 0-.3-.3h-.736a.3.3 0 0 0-.3.3v.736a.3.3 0 0 0 .3.3h.736a.3.3 0 0 0 .3-.3z" />
...
IconHourglassHalf24.displayName = 'IconHourglassHalf24';
