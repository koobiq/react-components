...
// @public (undocumented)
export const USE_TIMER_ERROR_EQ_TIME = "useTimer: `startTime` must not be equal to `endTime`.";

// @public (undocumented)
export const USE_TIMER_ERROR_MULTIPLICITY_INTERVAL_TO_END_TIME = "useTimer: `interval` must evenly divide `endTime`.";

// @public (undocumented)
export const USE_TIMER_ERROR_MULTIPLICITY_INTERVAL_TO_START_TIME = "useTimer: `interval` must evenly divide `startTime`.";
...
//
// @public
export function useDebounceCallback<CB extends FunctionCallback>(input: UseDebounceCallbackProps<CB>): UseDebounceCallbackReturnValue<CB>;
...
//
// @public
export function useEventListener<K extends keyof MediaQueryListEventMap>(input: UseEventListener<K, (event: MediaQueryListEventMap[K]) => void, RefObject_2<MediaQueryList>>): void;

// @public (undocumented)
export function useEventListener<K extends keyof WindowEventMap>(input: UseEventListener<K, (event: WindowEventMap[K]) => void, undefined>): void;

// @public (undocumented)
export function useEventListener<K extends keyof HTMLElementEventMap, T extends HTMLElement = HTMLDivElement>(input: UseEventListener<K, (event: HTMLElementEventMap[K]) => void, RefObject_2<T | null>>): void;

// @public (undocumented)
export function useEventListener<K extends keyof DocumentEventMap>(input: UseEventListener<K, (event: DocumentEventMap[K]) => void, RefObject_2<Document>>): void;
...
//
// @public (undocumented)
export function useInfiniteScroll<T extends HTMLElement = any>(input: UseInfiniteScrollOptions): {
...
//
// @public (undocumented)
export function useMultiRef<T>(refs: Array<Ref<T> | undefined>): RefCallback<T> | null;
...
// @public
export const useRefs: <T, Keys extends number | readonly string[] = number>(keys: Keys, deps?: unknown[]) => UseRefsReturn<T, Keys>;

// @public (undocumented)
export type UseRefsReturn<T, Keys extends number | readonly string[]> = Keys extends readonly string[] ? Record<Keys[number], RefObject_2<T>> : Array<RefObject_2<T>>;

// Warning: (ae-forgotten-export) The symbol "ObserverRect" needs to be exported by the entry point index.d.ts
//
// @public
export function useResizeObserver<T extends HTMLElement = any>(options?: ResizeObserverOptions): readonly [RefObject_2<T | null>, ObserverRect];

// @public (undocumented)
export const useResizeObserverRefs: <Element extends HTMLElement | SVGGraphicsElement, ReturnType>(refs: Array<RefObject_2<Element | null>>, mapper: (el: Element | null) => ReturnType) => ReturnType[];

export { useRouter }

// @public (undocumented)
export function useScrollPosition(el: HTMLElement | null): [ScrollPosition, (params: Partial<ScrollPosition>) => void];
