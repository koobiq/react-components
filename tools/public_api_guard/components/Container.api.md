...
// @public
export const Container: PolyForwardComponent<"div", ContainerBaseProps, ElementType>;
...
// @public (undocumented)
export const containerMarginsProp: readonly [0, "3xs", "xxs", "xs", "s", "m", "l", "xl", "xxl", "3xl", "4xl", "5xl", "6xl", "7xl"];
