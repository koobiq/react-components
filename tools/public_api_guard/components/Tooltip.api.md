...
// @public
export const Tooltip: ForwardRefExoticComponent<Omit<TooltipTriggerProps, "anchorRef" | "arrowBoundaryOffset" | "children" | "className" | "closeDelay" | "control" | "crossOffset" | "delay" | "hideArrow" | "id" | "offset" | "placement" | "portalContainer" | "style" | "variant" | `data-${string}` | keyof {
open?: boolean;
disabled?: boolean;
}> & {
...
// @public (undocumented)
export const tooltipPropPlacement: readonly ["bottom", "bottom start", "bottom end", "top", "top start", "top end", "start", "start top", "start bottom", "end", "end top", "end bottom"];
...
export type TooltipProps = ExtendableProps<{
    ...
    style?: CSSProperties;
    portalContainer?: Element;
} & TooltipDeprecatedProps & DataAttributeProps, TooltipTriggerProps_2>;

// @public (undocumented)
export type TooltipPropVariant = (typeof tooltipPropVariant)[number];

// @public (undocumented)
export const tooltipPropVariant: readonly ["contrast", "contrast-fade", "error", "warning", "theme"];
