...
// @public (undocumented)
export const ButtonToggle: ForwardRefExoticComponent<Omit<ButtonToggleProps, "ref"> & RefAttributes<HTMLButtonElement>>;

// @public
export const ButtonToggleGroup: ForwardRefExoticComponent<Omit<ButtonToggleGroupProps, "ref"> & RefAttributes<HTMLDivElement>>;
