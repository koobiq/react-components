...
// Warning: (ae-forgotten-export) The symbol "SelectOptionProps" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
...
// @public (undocumented)
export type SelectNextProps<T extends object, M extends SelectionMode_2 = 'single'> = ExtendableProps<{
...
// @public (undocumented)
export const selectNextPropSelectedTagsOverflow: readonly ["multiline", "responsive"];

// @public (undocumented)
export type SelectNextRef = ComponentRef<'div'>;

// Warning: (ae-forgotten-export) The symbol "SelectSectionProps" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export type SelectNextSectionProps<T extends object = object> = SelectSectionProps<T>;
