...
// @public (undocumented)
export const ActionsPanelContainer: (props: ActionsPanelContainerProps) => JSX.Element;
...
// @public (undocumented)
export const ActionsPanelContext: Context<ContextValue<ActionsPanelProps, HTMLDivElement>>;
